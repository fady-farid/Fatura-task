...
public final class ActivityAboutBinding implements ViewBinding {
  ...
  private ActivityAboutBinding(@NonNull FrameLayout rootView, @NonNull ToolbarBinding toolbar,
  ...
  public static ActivityAboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAboutBinding((FrameLayout) rootView, binding_toolbar, webview);
    }
