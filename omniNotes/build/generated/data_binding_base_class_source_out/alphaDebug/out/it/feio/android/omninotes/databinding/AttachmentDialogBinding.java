...
public final class AttachmentDialogBinding implements ViewBinding {
  ...
  public static AttachmentDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.camera;
      TextView camera = rootView.findViewById(id);
      if (camera == null) {
        break missingId;
      }

      id = R.id.files;
      TextView files = rootView.findViewById(id);
      if (files == null) {
        break missingId;
      }
      ...
      id = R.id.pushbullet;
      TextView pushbullet = rootView.findViewById(id);
      if (pushbullet == null) {
        break missingId;
      }

      id = R.id.recording;
      TextView recording = rootView.findViewById(id);
      if (recording == null) {
        break missingId;
      }

      id = R.id.sketch;
      TextView sketch = rootView.findViewById(id);
      if (sketch == null) {
        break missingId;
      }
      ...
      id = R.id.video;
      TextView video = rootView.findViewById(id);
      if (video == null) {
        break missingId;
      }
