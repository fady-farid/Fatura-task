...
public final class FragmentSketchBinding implements ViewBinding {
  ...
  public static FragmentSketchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.drawing;
      SketchView drawing = rootView.findViewById(id);
      if (drawing == null) {
        break missingId;
      }

      id = R.id.drawing_question;
      LinearLayout drawingQuestion = rootView.findViewById(id);
      if (drawingQuestion == null) {
        break missingId;
      }

      id = R.id.eraserView;
      LinearLayout eraserView = rootView.findViewById(id);
      if (eraserView == null) {
        break missingId;
      }

      id = R.id.sketch_erase;
      ImageView sketchErase = rootView.findViewById(id);
      if (sketchErase == null) {
        break missingId;
      }

      id = R.id.sketch_eraser;
      ImageView sketchEraser = rootView.findViewById(id);
      if (sketchEraser == null) {
        break missingId;
      }

      id = R.id.sketch_redo;
      ImageView sketchRedo = rootView.findViewById(id);
      if (sketchRedo == null) {
        break missingId;
      }

      id = R.id.sketch_stroke;
      ImageView sketchStroke = rootView.findViewById(id);
      if (sketchStroke == null) {
        break missingId;
      }

      id = R.id.sketch_undo;
      ImageView sketchUndo = rootView.findViewById(id);
      if (sketchUndo == null) {
        break missingId;
      }
