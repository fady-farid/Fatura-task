...
public final class PopupSketchStrokeBinding implements ViewBinding {
  ...
  public static PopupSketchStrokeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.opacitybar;
      OpacityBar opacitybar = rootView.findViewById(id);
      if (opacitybar == null) {
        break missingId;
      }

      id = R.id.stroke_circle;
      ImageView strokeCircle = rootView.findViewById(id);
      if (strokeCircle == null) {
        break missingId;
      }

      id = R.id.stroke_color_picker;
      ColorPicker strokeColorPicker = rootView.findViewById(id);
      if (strokeColorPicker == null) {
        break missingId;
      }

      id = R.id.stroke_seekbar;
      SeekBar strokeSeekbar = rootView.findViewById(id);
      if (strokeSeekbar == null) {
        break missingId;
      }

      id = R.id.svbar;
      SVBar svbar = rootView.findViewById(id);
      if (svbar == null) {
        break missingId;
      }
