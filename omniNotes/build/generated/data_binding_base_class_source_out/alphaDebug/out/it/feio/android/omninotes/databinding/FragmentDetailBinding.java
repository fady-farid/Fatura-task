...
public final class FragmentDetailBinding implements ViewBinding {
  ...
  public static FragmentDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ScrollView contentWrapper = rootView.findViewById(id);
      if (contentWrapper == null) {
        break missingId;
      }

      id = R.id.creation;
      TextView creation = rootView.findViewById(id);
      if (creation == null) {
        break missingId;
      }

      id = R.id.detail_attachments_above;
      ViewStub detailAttachmentsAbove = rootView.findViewById(id);
      if (detailAttachmentsAbove == null) {
        break missingId;
      }

      id = R.id.detail_attachments_below;
      ViewStub detailAttachmentsBelow = rootView.findViewById(id);
      if (detailAttachmentsBelow == null) {
        break missingId;
      }

      id = R.id.detail_content_card;
      CoordinatorLayout detailContentCard = rootView.findViewById(id);
      if (detailContentCard == null) {
        break missingId;
      }

      id = R.id.detail_root;
      LinearLayout detailRoot = rootView.findViewById(id);
      if (detailRoot == null) {
        break missingId;
      }

      id = R.id.detail_tile_card;
      LinearLayout detailTileCard = rootView.findViewById(id);
      if (detailTileCard == null) {
        break missingId;
      }

      id = R.id.detail_timestamps;
      LinearLayout detailTimestamps = rootView.findViewById(id);
      if (detailTimestamps == null) {
        break missingId;
      }

      id = R.id.detail_title;
      EditText detailTitle = rootView.findViewById(id);
      if (detailTitle == null) {
        break missingId;
      }

      id = R.id.detail_wrapper;
      LinearLayout detailWrapper = rootView.findViewById(id);
      if (detailWrapper == null) {
        break missingId;
      }

      id = R.id.fragment_detail_content;
      View fragmentDetailContent = rootView.findViewById(id);
      ...
      TextView lastModification = rootView.findViewById(id);
      if (lastModification == null) {
        break missingId;
      }

      id = R.id.snackbar_placeholder;
      CoordinatorLayout snackbarPlaceholder = rootView.findViewById(id);
      if (snackbarPlaceholder == null) {
        break missingId;
      }

      id = R.id.tag_marker;
      View tagMarker = rootView.findViewById(id);
      if (tagMarker == null) {
        break missingId;
      }

      id = R.id.title_wrapper;
      LinearLayout titleWrapper = rootView.findViewById(id);
