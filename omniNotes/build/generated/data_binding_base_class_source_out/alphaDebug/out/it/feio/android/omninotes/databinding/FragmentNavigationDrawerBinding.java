...
public final class FragmentNavigationDrawerBinding implements ViewBinding {
  ...
  public static FragmentNavigationDrawerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      NonScrollableListView drawerNavList = rootView.findViewById(id);
      if (drawerNavList == null) {
        break missingId;
      }

      id = R.id.drawer_tag_list;
      NonScrollableListView drawerTagList = rootView.findViewById(id);
      if (drawerTagList == null) {
        break missingId;
      }

      id = R.id.left_drawer;
      LinearLayout leftDrawer = rootView.findViewById(id);
      if (leftDrawer == null) {
        break missingId;
      }

      id = R.id.navdrawer_image;
      ImageView navdrawerImage = rootView.findViewById(id);
      if (navdrawerImage == null) {
        break missingId;
      }

      id = R.id.navdrawer_title;
      TextView navdrawerTitle = rootView.findViewById(id);
      if (navdrawerTitle == null) {
        break missingId;
      }

      id = R.id.settings_view;
      View settingsView = rootView.findViewById(id);
